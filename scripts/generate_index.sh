...
<html>
    <head>
        ...
        <script src="${PREFIX}js/remark-latest.min.js"></script>
        <script src="${PREFIX}js/jquery-3.1.0.js"></script>
    </head>
    <body>
        <script>
            ...
            slideshow.on('afterShowSlide', function (slide) {
                if (\$("div.remark-slide-content").find("div.logo").length == 0)
                {
                    ...
                    var fau = "<img src=\"${PREFIX}fau-logo-tech.png\" class=\"logo-img-fau\"></img>";
                    var cscs = "<img src=\"${PREFIX}CSCS_2_CMYK.jpg\" class=\"logo-img-cscs\"></img>";
                    var logo = \$("<div class=\"logo\">" + stellar + fau + cscs + "</div>")
